...
if p.periodic_boundaries 
    element_neighbours(bot_elem, 6:8) = element_neighbours(bot_elem, 6:8) + (N_element_x-1)*N_element_y;
    element_neighbours(right_elem, [1 2 8]) = element_neighbours(right_elem, [1 2 8]) - N_element_x;
    element_neighbours(top_elem, 2:4) = element_neighbours(top_elem, 2:4) - (N_element_x-1)*N_element_y;
    element_neighbours(left_elem, 4:6) = element_neighbours(left_elem, 4:6) + N_element_x;
end
